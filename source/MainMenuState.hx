...
{
	public static var editVer:String = '0.3.3h';
	public static var psychEngineVersion:String = '0.6.3'; //This is also used for Discord RPC
	public static var gitBuild:String = 'e75b42f'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		versionShit.scrollFactor.set();
		versionShit.setFormat(Paths.font("font.ttf"), 16, 0xFF77DD77, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
