...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		noModsTxt.setFormat(Paths.font("font.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		buttonToggle.label.setFormat(Paths.font("font.ttf"), 24, FlxColor.WHITE, CENTER);
		...
		buttonUp.label.setFormat(Paths.font("font.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		buttonDown.label.setFormat(Paths.font("font.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		buttonTop.label.setFormat(Paths.font("font.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		buttonDisableAll.label.setFormat(Paths.font("font.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		buttonEnableAll.label.setFormat(Paths.font("font.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		descriptionTxt.setFormat(Paths.font("font.ttf"), 32, FlxColor.WHITE, LEFT);
